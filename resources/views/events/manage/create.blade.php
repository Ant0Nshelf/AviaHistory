...
<head>
    ...
    <title>Створення нової події - Історія авіації на Закарпатті</title>
...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead">Додайте нову подію до історії авіації на Закарпатті</p>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4 animate__animated animate__fadeInLeft">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Створення нової події</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('events.manage.store') }}" method="POST" id="createEventForm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-4">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" required placeholder="Введіть назву події">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="event_date" class="form-label"><i class="fas fa-calendar-alt me-1"></i> Дата події</label>
                                        <input type="text" class="form-control datepicker" id="event_date" name="event_date" value="{{ old('event_date') }}" required placeholder="Виберіть дату">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control description-editor" id="description" name="description" rows="10" required placeholder="Детальний опис події...">{{ old('description') }}</textarea>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="card mb-4 sticky-top animate__animated animate__fadeInRight" style="top: 20px;">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fas fa-cog me-2"></i>Дії</h5>
                    </div>
                    <div class="card-body">
                        <div class="d-grid gap-3">
                            <button type="submit" form="createEventForm" class="btn btn-primary btn-lg">
                                <i class="fas fa-save me-2"></i>Створити подію
                            </button>
                        ...
                        <div class="mt-4">
                            <h6 class="text-muted mb-3">Підказки</h6>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item px-0">
                                    <i class="fas fa-info-circle text-primary me-2"></i> Вкажіть точну назву події
                                </li>
                                <li class="list-group-item px-0">
                                    <i class="fas fa-info-circle text-primary me-2"></i> Виберіть дату події
                                </li>
                                <li class="list-group-item px-0">
                                    <i class="fas fa-info-circle text-primary me-2"></i> Додайте якісне зображення
                                </li>
                                <li class="list-group-item px-0">
                                    <i class="fas fa-info-circle text-primary me-2"></i> Напишіть детальний опис
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <h5><i class="fas fa-envelope me-2"></i> Контакти</h5>
                    <address>
                        <p><i class="fas fa-map-marker-alt me-2"></i> Ужгород, Закарпатська область</p>
                        <p><i class="fas fa-envelope me-2"></i> Email: info@aviahistory.com</p>
                        <div class="mt-3">
