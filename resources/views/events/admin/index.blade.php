                            ...
                            @forelse($events as $event)
                                <tr class="event-row" data-location="{{ $event->location_id }}">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('events.events.edit', $event) }}" class="btn btn-primary btn-action" title="Редагувати" data-bs-toggle="tooltip">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('events.events.destroy', $event) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
