        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('events.manage.*') ? 'active' : '' }}" href="{{ route('events.manage.index') }}">
                                <i class="fas fa-calendar-alt me-1"></i>Події
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('locations.manage.*') ? 'active' : '' }}" href="{{ route('locations.manage.index') }}">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead">@yield('header-subtitle')</p>
                </div>
