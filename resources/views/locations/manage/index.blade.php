...
<head>
    ...
    <title>Управління локаціями - Історія авіації на Закарпатті</title>
    ...
    <header class="page-header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1><i class="fas fa-map-marker-alt me-2"></i>Управління локаціями</h1>
                    <p class="lead">Створюйте, редагуйте та видаляйте локації для подій</p>
                </div>
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-4">
                                        <div class="alert alert-info mb-0">
                                            <i class="fas fa-info-circle me-2"></i>Локації не знайдено
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
